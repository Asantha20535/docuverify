            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-md font-medium text-gray-900 mb-4">Document Types & Workflows</h4>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                        <div>
                          <span className="text-sm font-medium text-gray-900">Transcript Request</span>
                          <p className="text-xs text-gray-600">Staff → Head → Dean → VC → Registrar</p>
                        </div>
                        <Button variant="outline" size="sm" data-testid="button-edit-workflow">Edit</Button>
                      </div>
                      <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                        <div>
                          <span className="text-sm font-medium text-gray-900">Enrollment Verification</span>
                          <p className="text-xs text-gray-600">Staff → Head → Dean</p>
                        </div>
                        <Button variant="outline" size="sm">Edit</Button>
                      </div>
                      <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                        <div>
                          <span className="text-sm font-medium text-gray-900">Grade Report</span>
                          <p className="text-xs text-gray-600">Staff → Head</p>
                        </div>
                        <Button variant="outline" size="sm">Edit</Button>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-sm font-medium text-gray-900">Auto-approval timeout</span>
                          <p className="text-xs text-gray-600">Automatically move to next step after X days</p>
                        </div>
                        <input type="number" defaultValue="7" className="w-16 px-2 py-1 border border-gray-300 rounded text-sm" />
                      </div>
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-sm font-medium text-gray-900">Max file size (MB)</span>
                          <p className="text-xs text-gray-600">Maximum upload size for documents</p>
                        </div>
                        <input type="number" defaultValue="10" className="w-16 px-2 py-1 border border-gray-300 rounded text-sm" />
                      </div>
                    </div>
                  </div>
                </div>
