...
export default function CourseUnitDashboard() {
  ...
  const { data: transcriptRequests = [], isLoading: requestsLoading } = useQuery<TranscriptRequest[]>({
                  ...
                  <div key={request.id} className="border rounded-lg p-4 hover:bg-gray-50">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                      ...
                      <div className="text-xs">
                        {request.student.isGraduated ? (
                          <span className="text-green-600">Full transcript → Assistant Registrar</span>
                        ) : (
                          <span className="text-blue-600">Partial transcript → Dean</span>
                        )}
                      </div>
                    </div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  ...
                  <p><strong>Will be forwarded to:</strong> {
                    selectedRequest.student.isGraduated ? "Assistant Registrar" : "Dean"
                  }</p>
                </div>
              </div>
